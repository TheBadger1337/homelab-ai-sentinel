...
| WhatsApp message returns 200, never delivered | Phone Number ID used instead of actual phone number — two different values in Meta's portal | Use the numeric Phone Number ID (not your E.164 number) in `WHATSAPP_PHONE_ID`. Check the API Setup page in your Meta app dashboard. |
