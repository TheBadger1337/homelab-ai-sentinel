...
[![Tests](https://img.shields.io/badge/tests-297%20passing-22c55e?style=flat-square)](#running-tests)
...
| 🧪 **Production-Hardened** | 297 tests — auth, deduplication, rate limiting, retry/backoff, graceful fallback, all 11 parsers, all 10 clients |
| 💸 **Free to Run** | Gemini 2.5 Flash free tier: 10 RPM, 500 req/day — more than enough for a homelab |
...
**297 tests** — all 11 parsers, all 10 notification clients, parallel dispatch, auth, deduplication, rate limiting, retry/backoff, Flask error handlers. No network access required.
...
| Discord + Slack + Ntfy + Email | The four straightforward ones — best practices, webhook security, App Passwords | $9 |
...
| **Homelab AI Blueprint** | Everything — all platform guides, full monitoring stack (Uptime Kuma, Grafana, Prometheus, Netdata, Glances), Docker networking, AI agent layer, LLM provider swap guide, production deployment playbook | $59 |
