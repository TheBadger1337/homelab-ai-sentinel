...
from . import discord_client, slack_client, telegram_client, ntfy_client, email_client, whatsapp_client, signal_client

logger = logging.getLogger(__name__)

_CLIENTS: list[types.ModuleType] = [discord_client, slack_client, telegram_client, ntfy_client, email_client, whatsapp_client, signal_client]
